...
public class PersianDatePickerDialog {
  ...
  private Integer selectedDateTextColor = null;
  ...
  public PersianDatePickerDialog setDateTextColor(@ColorInt int colorInt) {
    this.dateTextColor = colorInt;
    return this;
  }

  public PersianDatePickerDialog setDateTextColorResource(@ColorRes int colorInt) {
    this.dateTextColor = ContextCompat.getColor(context, colorInt);
    return this;
  }

  public PersianDatePickerDialog setSelectedDateTextColor(@ColorInt int colorInt) {
    this.selectedDateTextColor = colorInt;
    return this;
  }

  public PersianDatePickerDialog setSelectedDateTextColorResource(@ColorRes int colorInt) {
    this.selectedDateTextColor = ContextCompat.getColor(context, colorInt);
    return this;
  }

  public PersianDatePickerDialog setTextSize(float textSize) {
  ...
  public void show() {
    ...
    if (dateTextColor != null) {
      datePicker.setDateTextColor(dateTextColor);
    }
    if (selectedDateTextColor != null) {
      datePicker.setSelectedDateTextColor(selectedDateTextColor);
    }
    if (textSize != null) {
